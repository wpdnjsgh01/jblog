...
public class MvcConfig extends WebMvcConfigurerAdapter {
	 ...
	 * mappingJackson2HttpMessageConverter() { Jackson2ObjectMapperBuilder builder =
	 * new Jackson2ObjectMapperBuilder() .indentOutput(true) .dateFormat(new
	 * SimpleDateFormat("yyyy-mm-dd"));
	 * 
	 * MappingJackson2HttpMessageConverter messageConverter = new
	 * MappingJackson2HttpMessageConverter(builder.build());
	 * messageConverter.setSupportedMediaTypes( Arrays.asList( new
